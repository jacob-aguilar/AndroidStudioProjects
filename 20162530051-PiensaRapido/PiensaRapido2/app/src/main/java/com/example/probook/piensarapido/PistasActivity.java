...
import android.widget.ListView;//Corresponden a Listado
...
public class PistasActivity extends AppCompatActivity {
    ...
    ArrayList<Pistas>  listItems = new ArrayList<>();
         listItems.add(new Pistas(R.mipmap.pregunta10, "Nivel 1", "No es 6"));
         ...
         listItems.add(new Pistas(R.mipmap.calendario, "Nivel 10", "Todos los meses tienen 28 dias"));

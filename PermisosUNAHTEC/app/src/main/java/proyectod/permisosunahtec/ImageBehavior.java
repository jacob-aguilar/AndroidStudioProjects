...
//Esta clase nos permite hacer las transiciones en el layout de informacion de empleado para su interfaz
public class ImageBehavior extends CoordinatorLayout.Behavior {
    private final static float MIN_AVATAR_PERCENTAGE_SIZE   = 0.9f;
    private final static int EXTRA_FINAL_AVATAR_PADDING     = 70;
